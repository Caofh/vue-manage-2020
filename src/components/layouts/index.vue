  ...
  <div class="vue-admin-beautiful-wrapper" :class="classObj">
    ...
    >
      ...
      <div class="vab-main" :class="collapse ? 'is-collapse-main' : ''">
        <div class="lite-manage-nav-bar" :class="header === 'fixed' ? 'fixed-header' : ''">
...
export default {
  ...
  mounted() {
    ...
    if (userAgent.includes("Juejin")) {
      this.$baseAlert(
        "lite-manage不支持在掘金内置浏览器演示，请手动复制以下地址到浏览器中查看http://mpfhrd48.sanxing.uz7.cn/vue-admin-beautiful"
      );
    }
    ...
    if (isMobile) {
      if (isMobile) {
        ...
        this.$store.dispatch("changeLayout", "vertical");
      } else {
        this.$store.dispatch("changeLayout", this.oldLayout);
      }
